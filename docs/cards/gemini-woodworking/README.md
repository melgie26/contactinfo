# Gemini Woodworking NFC demo

Static, mobile-first demo landing page for Gemini Woodworking. It has no database, credentials, analytics, form submission, or visitor-data storage.
...
## Brief-supplied or demo information

- Family-run business
- Cutting boards and broader positioning copy
- The visual branding treatment is original demo creative
...
This folder is designed to be served directly as a static path at `/cards/gemini-woodworking/` by the existing repository's GitHub Pages output.
